...
if __name__ == '__main__':
    step = 74
    path = "checkpoints/opensource_test/qwen3_8B_test"
    local_dir = f"{path}/global_step_{step}/actor"  # 这里需要替换为绝对路径
    hf_path = f"{path}/global_step_{step}/actor/huggingface"  # 这里需要替换为绝对路径
    output_path = f"{path}/final"  # 这里需要替换为绝对路径
